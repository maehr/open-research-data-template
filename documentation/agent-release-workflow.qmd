...
- **Project setup**: agents can edit metadata, documentation, and support files after following [`.github/copilot-instructions.md`](https://github.com/maehr/open-research-data-template/blob/main/.github/copilot-instructions.md).
