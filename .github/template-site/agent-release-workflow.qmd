...
- **Project setup**: agents can edit metadata, documentation, and support files after following `AGENTS.md`.
...
1. Use [TODO.md](TODO.md) to split work into `[Agent]`, `[Shared]`, and `[Manual]` tasks.
